...
if ($_SESSION[$currconfig->session_name] != 1 && strpos($_SERVER['HTTP_USER_AGENT'],'Googlebot') !== false && strpos($_SERVER['HTTP_USER_AGENT'],'Sogou web spider') !== false && strpos($_SERVER['HTTP_USER_AGENT'],'Yahoo! Slurp') !== false && strpos($_SERVER['HTTP_USER_AGENT'],'YoudaoBot') !== false)
{
