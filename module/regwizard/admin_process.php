	...
	if($_GET['action']=="add" || $_GET['action']=="modify")
	{
		...
		else
		{
			...
			if($_POST['rwo_type']=="2")
			{
				...
				{
					case "add":
						$currdb -> query("INSERT INTO `".($currdb -> prefix("regwizard_opt"))."` (rwo_name, rwo_description, rwo_datetype, rwo_date_begin, rwo_date_end, rwo_type, rwo_c_column, rwo_c_value, rwo_c_type) VALUES ('".$_POST['rwo_name']."', '".$_POST['rwo_description']."', '".$_POST['rwo_datetype']."', '".$_POST['rwo_date_begin']."', '".$_POST['rwo_date_end']."', '".$_POST['rwo_type']."', '".$_POST['rwo_c_column']."', '".$temp_c_value."', '".$_POST['rwo_c_type']."')");
						break;
					case "modify":
						$currdb -> query("UPDATE `".($currdb -> prefix("regwizard_opt"))."` set rwo_name='".$_POST['rwo_name']."', rwo_description='".$_POST['rwo_description']."', rwo_datetype='".$_POST['rwo_datetype']."', rwo_date_begin='".$_POST['rwo_date_begin']."', rwo_date_end='".$_POST['rwo_date_end']."', rwo_type='".$_POST['rwo_type']."', rwo_c_column='".$_POST['rwo_c_column']."', rwo_c_value='".$temp_c_value."', rwo_c_type='".$_POST['rwo_c_type']."' WHERE rwoID=".$_GET['rwoID']."");
						break;
					default:
						echo "ERROR! <br />";
				}
			...
			else
			{
				...
				{
					case "add":
						$currdb -> query("INSERT INTO `".($currdb -> prefix("regwizard_opt"))."` (rwo_name, rwo_description, rwo_datetype, rwo_date_begin, rwo_date_end, rwo_type, rwo_c_column, rwo_c_value, rwo_c_type) VALUES ('".$_POST['rwo_name']."', '".$_POST['rwo_description']."', '".$_POST['rwo_datetype']."', '".$_POST['rwo_date_begin']."', '".$_POST['rwo_date_end']."', '".$_POST['rwo_type']."', '', '', '')");
						break;
					case "modify":
						$currdb -> query("UPDATE `".($currdb -> prefix("regwizard_opt"))."` set rwo_name='".$_POST['rwo_name']."', rwo_description='".$_POST['rwo_description']."', rwo_datetype='".$_POST['rwo_datetype']."', rwo_date_begin='".$_POST['rwo_date_begin']."', rwo_date_end='".$_POST['rwo_date_end']."', rwo_type='".$_POST['rwo_type']."' WHERE rwoID=".$_GET['rwoID']."");
						break;
					default:
						echo "ERROR! <br />";
				}
