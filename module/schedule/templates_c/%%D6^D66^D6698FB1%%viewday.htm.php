<?php /* Smarty version 2.6.18, created on 2008-11-06 15:16:57
         compiled from viewday.htm */ ?>
<div class="blue_back">
	<div class="field_top_top">
		<img src="templates/images/calendar.gif" class="field_title"/>
...
<div class="field_content">
	<div class="mday-td"><?php echo $this->_tpl_vars['c_block']; ?>
</div>
</div>
