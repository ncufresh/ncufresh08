<?php /* Smarty version 2.6.18, created on 2009-05-10 19:22:41
...
"><?php echo $this->_tpl_vars['title'][$this->_sections['gb']['index']]; ?>
      ...
      <div style="float:right"><a href="switchPublic.php?sno=<?php echo $this->_tpl_vars['SN'][$this->_sections['gb']['index']]; ?>
">切換此份問卷是否開放</a></div>
  	<?php endfor; endif; ?> <br />
        <br />
