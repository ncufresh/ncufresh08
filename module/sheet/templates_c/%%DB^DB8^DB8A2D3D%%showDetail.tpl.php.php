<?php /* Smarty version 2.6.18, created on 2009-01-17 18:05:45
         compiled from showDetail.tpl.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'showDetail.tpl.php', 49, false),)), $this); ?>
<script type="text/javascript">
	...
	問題<?php echo $this->_tpl_vars['qis']; ?>
...
?> 
    <div class="chooses">
	 選項<?php echo $this->_sections['choose']['iteration']; ?>
:
...
<br/><br />--------------------------------------------------<br /><br />
    ...
    <?php else: ?>
		...
		<?php endif; ?>
	<?php endif; ?><br /><br />
  <div style="float:left;clear:both"> <a href="showStatics.php?sno=<?php echo $this->_tpl_vars['sno']; ?>
"><input type="button" name="button" id="button" value="上一頁"/></a></div>
    <a onclick="switchgraph();return false;" href="showStatics.php?sno=<?php echo $this->_tpl_vars['sno']; ?>
&qis=<?php echo $this->_tpl_vars['qis']; ?>
&show=<?php echo $this->_tpl_vars['switch']; ?>
"><div style="float:right;clear:both"> <input type="button" name="button" id="button" value="切換圖表" ></a></div>
</td></table>